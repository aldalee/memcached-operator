...
func (r *MemcachedReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	err = r.Get(ctx, client.ObjectKey{Name: memcached.Name, Namespace: memcached.Namespace}, found)
...
func (r *MemcachedReconciler) deploymentForMemcached(m *cachev2.Memcached) *appsv1.Deployment {
